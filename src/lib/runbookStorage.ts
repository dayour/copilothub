...
class RunbookStorage {
  ...
  public async getRunbooksDir(): Promise<string> {
    if (!isTauri) {
      throw new Error('Runbook file storage is only available inside the CopilotHub Tauri shell.');
    }
  ...
  public async readRunbook(filename: string): Promise<string> {
    if (!isTauri) {
      throw new Error('Runbook files can only be opened from the CopilotHub Tauri shell.');
    }
  ...
  public async writeRunbook(filename: string, content: string): Promise<void> {
    if (!isTauri) {
      throw new Error('Runbook files can only be saved from the CopilotHub Tauri shell.');
    }
  ...
  public async deleteRunbook(filename: string): Promise<void> {
    if (!isTauri) {
      throw new Error('Runbook files can only be deleted from the CopilotHub Tauri shell.');
    }
