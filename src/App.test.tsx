...
describe('App shell layout', () => {
  ...
  it('routes Microsoft tabs through the dedicated Microsoft panel and hides browser chrome in browser-host mode', () => {
    useTabStore.setState({
      tabs: [
        ...
        createTab({
          id: 'copilot-studio-tab',
          type: 'copilot-studio',
          title: 'Copilot Studio',
          url: 'https://copilotstudio.microsoft.com',
          isActive: true,
          historyStack: ['https://copilotstudio.microsoft.com'],
          historyIndex: 0,
        }),
      ],
    });
  ...
  it('keeps chat usable and exposes a reopen control when the assistant panel is collapsed', () => {
    ...
    expect(screen.getByRole('button', { name: 'Open terminal tab' })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: 'Open browser tab' })).toBeInTheDocument();
