          ...
          <div className="flex-1 overflow-hidden relative">
            {tabs.map((tab) => {
              switch (tab.type) {
                ...
                case 'browser-use':
                  return (
                    <Suspense fallback={<TabContentFallback isActive={tab.isActive} className="w-full h-full" />}>
                      <BrowserUseTab key={tab.id} isActive={tab.isActive} />
                    </Suspense>
                  );
                case 'copilot-studio':
                  return (
                ...
                case 'vscode':
                  return (
                    <Suspense fallback={<TabContentFallback isActive={tab.isActive} className="w-full h-full" />}>
                      <LazyVSCodeTab key={tab.id} tabId={tab.id} isActive={tab.isActive} />
                    </Suspense>
                  );
                case 'terminal':
                  return (
