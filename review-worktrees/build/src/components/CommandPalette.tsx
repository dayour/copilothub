...
export function CommandPalette() {
  ...
  const commands: Command[] = useMemo(() => {
    ...
    return [
      ...
      {
        id: 'open-copilot-studio-panel',
        label: 'Open Copilot Studio Panel',
        category: 'Microsoft',
        icon: <Bot size={16} />,
        action: () => { addTab('copilot-studio'); close(); },
      },
      {
        id: 'open-power-platform-panel',
        label: 'Open Power Platform Panel',
        category: 'Microsoft',
        icon: <Layers3 size={16} />,
        action: () => { addTab('power-platform'); close(); },
      },
      {
        id: 'open-power-automate-maker',
        label: 'Open Power Automate Maker',
        category: 'Microsoft',
        icon: <Layers3 size={16} />,
        action: () => { addTab('power-platform', POWER_AUTOMATE_URL); close(); },
      },
      {
      ...
      {
        id: 'showcase-coffee-coach',
        label: 'Showcase: Coffee Virtual Coach',
        category: 'Agent Showcases',
        icon: <Coffee size={16} />,
        action: () => { addTab('showcase-coffee'); close(); },
      },
      {
        id: 'showcase-clothing-analysis',
        label: 'Showcase: Clothing Power Analysis',
        category: 'Agent Showcases',
        icon: <BarChart3 size={16} />,
        action: () => { addTab('showcase-clothing'); close(); },
      },
      {
        id: 'showcase-claims-assistant',
        label: 'Showcase: Insurance Claims Assistant',
        category: 'Agent Showcases',
        icon: <FileCheck size={16} />,
        action: () => { addTab('showcase-insurance'); close(); },
      },
      {
        id: 'showcase-it-helpdesk',
        label: 'Showcase: IT Help Desk',
        category: 'Agent Showcases',
        icon: <Headphones size={16} />,
        action: () => { addTab('showcase-it-helpdesk'); close(); },
      },
      {
        id: 'showcase-seller-prospect',
        label: 'Showcase: Seller Prospect',
        category: 'Agent Showcases',
        icon: <Users size={16} />,
        action: () => { addTab('showcase-seller'); close(); },
      },
      {
        id: 'showcase-fleet-coordinator',
        label: 'Showcase: Fleet Coordinator',
        category: 'Agent Showcases',
        icon: <Truck size={16} />,
        action: () => { addTab('showcase-fleet'); close(); },
      },
      {
        id: 'showcase-fuel-tracking',
        label: 'Showcase: Fuel Tracking',
        category: 'Agent Showcases',
        icon: <Fuel size={16} />,
        action: () => { addTab('showcase-fuel'); close(); },
      },
      {
      ...
      // -- View ------------------------------------------------------------
      {
        ...
        action: () => { close(); openSettingsPanel(); },
      },
      {
      ...
      {
        id: 'open-git-review-pane',
        label: 'Open Git Review Pane',
        category: 'View',
        shortcut: 'Ctrl+Shift+R',
        icon: <GitBranch size={16} />,
        action: () => { openReviewPane(); close(); },
      },
      ...
      {
        id: 'browser-use-new-session',
        label: 'Browser: New Browser Use Session',
        category: 'Browser Use',
        icon: <MousePointerClick size={16} />,
        action: () => { useTabStore.getState().addTab('browser-use'); close(); },
      },
      {
        ...
        category: 'Browser Use',
        icon: <Camera size={16} />,
        action: () => { mcpClient.screenshot(); close(); },
      },
      {
        id: 'browser-use-start-recording',
      ...
      },
      {
        ...
        label: 'Browser: Show Action Timeline',
        category: 'Browser Use',
        icon: <Activity size={16} />,
        action: () => {
          const store = useAppStore.getState();
          store.setActionTimelineDocked(store.actionTimelineDocked === 'hidden' ? 'right' : 'hidden');
          close();
        },
      },
