        ...
        .add_child(
            WebviewBuilder::new(&label, WebviewUrl::External(parsed))
                ...
                .on_page_load(move |webview, payload| {
                    ...
                    let _ = loading_app.emit(
                        "browser://loading",
                        BrowserLoadingEvent {
                            label: loading_label.clone(),
                            is_loading: matches!(payload.event(), PageLoadEvent::Started),
                            url: current_url,
                        },
                    );
                })
...
/// Reload an existing child webview.
#[tauri::command]
...
/// Ask an existing child webview to navigate backward through its session history.
#[tauri::command]
...
/// Ask an existing child webview to navigate forward through its session history.
#[tauri::command]
...
/// Stop the current child webview navigation.
#[tauri::command]
